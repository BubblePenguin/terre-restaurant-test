...
const NavBar = () => {
  return (
    <nav className="z-20 absolute left-0 right-0 bg-transparent w-auto desktop:w-desktop ldesktop:w-ldesktop h-32 text-white text-[20px] px-[10px] tsblet:px-[20px] desktop:px-[120px]">
